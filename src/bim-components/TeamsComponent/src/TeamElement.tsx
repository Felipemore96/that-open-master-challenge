...
import { WorldContext } from "../../../react-components/IFCViewer";
...
export class TeamElement extends OBC.Component {
  static uuid = "09c50dfd-6173-4d40-90a0-9f5ceae6cc4a"
  enabled = true

  constructor(components: OBC.Components) {
    super(components)
    this.components.add(TeamElement.uuid, this)
  }
